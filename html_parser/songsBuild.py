...
def getNextLink():
    ...
    resp = requests.get("http://172.25.21.208:8080/getLink", params={'type':'1'})
...
def updateSongsByArtist(key, value1, value2):
	send = requests.post("http://172.25.21.208:8080/updateData", params={'link':key, 'data':value1, 'data':value2, 'type':'1'})

def finishSongs(link):
	send = requests.post("http://172.25.21.208:8080/finished", params={'link':link, 'type':'1'})
