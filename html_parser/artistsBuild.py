...
def getNextLink():
    ...
    resp = requests.get("http://104.198.254.12:8080/getLink", params={'type':'0'})
...
def updateArtists(key, value):
	send = requests.post("http://104.198.254.12:8080/updateData", params={'link':key, 'data':value, 'type':'0'})

def finishArtists(link):
	send = requests.post("http://104.198.254.12:8080/finished", params={'link':link, 'type':'0'})
